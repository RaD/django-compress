...
from compress.utils import static_root, static_url, needs_update, filter_css, filter_js, get_output_filename, get_version, get_version_from_file
...
def render_common(template_name, obj, filename, version):
    ...
    if filename.startswith('http://'):
        ...
        context['url'] = static_url(filename, prefix)
    ...
    def render(self, context):
        ...
        if settings.COMPRESS:
            ...
            if settings.COMPRESS_AUTO:
                ...
                path_name = static_root(filename_base)
